...
public class AddContactActivity extends BaseToolbarActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.contact_save_button:
                ...
                if (isValidData()) {
                    ...
                    dbManager.createContact(name, phone, mail, image);
                    this.returnHome();

                    Toast.makeText(getApplicationContext(), "Contact Added!!!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Your contact is not added!!", Toast.LENGTH_SHORT).show();
                }
                break;
